      ...
      <div className={`w-full bg-slate-900 text-white/90 px-4 md:px-8 pointer-events-auto transition-all duration-500 origin-top ${scrolled ? 'h-0 opacity-0 overflow-hidden py-0' : 'h-auto opacity-100 py-2.5'}`}>
        <div className="w-[95vw] md:w-[90vw] mx-auto flex justify-between items-center text-[10.5px] md:text-xs font-bold tracking-widest uppercase">
          ...
          <div className="flex items-center gap-5">
            <a href="https://www.facebook.com/etech1etech" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors" aria-label="Facebook">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/></svg>
            </a>
            <a href="https://www.instagram.com/etech_group_of_institutions?igsh=MW5yc2V2cG5wcG8xbQ==" target="_blank" rel="noopener noreferrer" className="hover:text-rose-400 transition-colors" aria-label="Instagram">
