...
export default function AchievementsHero() {
  ...
  return (
    <section className="relative w-full h-[60vh] md:h-[65vh] flex items-center justify-center overflow-hidden bg-[#1E3A8A]">
      ...
      <style>{`
        @keyframes achievementsWaveFloat {
      ...
      <div className="absolute inset-0 z-0 pointer-events-none opacity-80 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#fbbf24]/10 rounded-full blur-[140px]" />
        ...
        <svg
          ...
          style={{ animation: "achievementsWaveFloat 20s ease-in-out infinite alternate" }}
        >
          <path
      ...
      <div className="relative z-10 w-[92vw] sm:w-[90vw] mx-auto px-2 sm:px-6 text-center mt-20 md:mt-28">
        ...
        >
          ...
          <svg
            className="absolute -bottom-5 left-1/2 -translate-x-1/2 w-[110%] h-[20px] md:h-[24px] text-[#fbbf24]"
            viewBox="0 0 200 24"
            fill="none"
            preserveAspectRatio="none"
          >
        ...
        >
          Celebrating the academic excellence, hard work, and brilliant success of our top-performing students.
        </p>
      </div>
