      ...
      <div className="relative z-10 w-[90vw] mx-auto px-6 sm:px-12 lg:px-16 pb-12 md:pb-20">
        ...
        >
          ...
          <span className="relative inline-block">
            <span className="text-blue-400">eTech</span>
        ...
        >
          Odisha&apos;s premier academy — shaping futures through quality
          education, rigorous coaching, and unwavering commitment to
