          ...
          <div className="lg:col-span-5 flex flex-col gap-8 reveal">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 mt-6 flex flex-col gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <a href="https://www.instagram.com/etech_group_of_institutions?igsh=MW5yc2V2cG5wcG8xbQ==" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 rounded-xl bg-rose-50 text-rose-600 hover:bg-rose-600 hover:text-white shadow-sm border border-rose-100 transition-all duration-300 group">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
